...
const socialLinks = [
  ...
  {
    name: 'Instagram',
    href: 'https://instagram.com/donato_totes',
    handle: '@donato_totes',
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex items-center justify-between h-16">
          ...
          <a href="#" className="flex items-center space-x-2 group">
            <div className="w-8 h-8 bg-linear-to-br from-blue-500 to-purple-600 rounded-lg flex items-center justify-center group-hover:scale-110 transition-transform duration-200">
          ...
          <nav className="hidden md:flex items-center space-x-1">
            {navItems.map((item) => (
              <a
                key={item.name}
                href={item.href}
                className="px-4 py-2 text-sm font-medium text-slate-700 rounded-lg hover:bg-slate-100 hover:text-slate-900 transition-colors duration-150"
              >
                {item.name}
              </a>
            ))}
            ...
            <div className="relative" ref={dropdownRef}>
              <button
                ...
                className="flex items-center space-x-1 px-4 py-2 text-sm font-medium text-slate-700 rounded-lg hover:bg-slate-100 hover:text-slate-900 transition-colors duration-150"
              >
                <span>Socials</span>
                <svg
                ...
                <div className="absolute right-0 mt-2 w-64 bg-white rounded-xl shadow-lg border border-slate-200 py-2 z-50">
                  {socialLinks.map((social) => (
                    <a
                      ...
                      className="flex items-center space-x-3 px-4 py-3 hover:bg-slate-50 transition-colors duration-150 group"
                    >
                      <div className={`w-10 h-10 bg-linear-to-br ${social.gradient} rounded-lg flex items-center justify-center group-hover:scale-110 transition-transform duration-200`}>
              ...
              <div className="pt-2 border-t border-slate-200 mt-2">
                ...
                {socialLinks.map((social) => (
                  <a
                    ...
                    target="_blank"
                    rel="noopener noreferrer"
                    className="flex items-center space-x-3 px-4 py-2 text-sm font-medium text-slate-700 rounded-lg hover:bg-slate-100 hover:text-slate-900 transition-colors duration-150"
                  >
                    <div className={`w-8 h-8 bg-linear-to-br ${social.gradient} rounded-lg flex items-center justify-center`}>
